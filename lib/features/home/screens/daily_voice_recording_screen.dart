...
class DailyVoiceRecordingScreen extends StatelessWidget {
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(
              onPressed: () => Get.to(() => const AudioRecordingScreen()),
            ...
            Row(
              children: [
                _buildSmallStatCard("Current Streak", "12 Days", Icons.bolt, Color(0xFF26A69A)),
                const SizedBox(width: 16),
                _buildSmallStatCard("Average Score", "70%", Icons.percent, Color(0xFF26A69A)),
              ],
            ),
            const SizedBox(height: 32),
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(
                    fontSize: 12,
                    color: isActive ? Colors.white.withOpacity(0.8) : const Color(0xFF94A3B8),
                  ),
                ),
              ],
            ),
