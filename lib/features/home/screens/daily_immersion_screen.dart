...
class DailyImmersionScreen extends StatelessWidget {
// ...
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            ElevatedButton(
              onPressed: () => Get.to(() => const ImmersionEntryScreen()),
            ...
            SingleChildScrollView(
              ...
              child: Row(
                children: [
                  _buildFilterChip("All Immersion", isActive: true),
            ...
            // Items
            _buildListItem("1.", "Prison Break", "Lasting for a very short time..."),
            _buildListItem("2.", "Escape Plan", "A sound that is sweet and smooth, pleasing to hear..."),
  ...
  Widget _buildListItem(String number, String title, String subtitle) {
    return Container(
